...
@Component
public class WeMobileService extends Providers{
...
//        customerTable=table.getCustomerTable();
        ...
        transactionsTable.add(new Transaction(rechargeItem.getEmail(),transactionsTable.size()+1,rechargeItem.getAmount(),rechargeItem.getNumber(),"We Mob Service"));
        return "Recharge has done successfully and your operation ID is "+transactionsTable.size()+" and you pay "+money+" only for We Mobile service";
    }
