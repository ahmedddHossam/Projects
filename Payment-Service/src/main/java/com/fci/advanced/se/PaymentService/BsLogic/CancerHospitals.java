...
@Service
public class CancerHospitals extends Providers{
    ...
    public String recharge(RechargeItem rechargeItem) {
        ...
        transactionsTable.add(new Transaction(rechargeItem.getEmail(),transactionsTable.size()+1,rechargeItem.getAmount(),rechargeItem.getNumber(),"Cancer Hospitals donation"));
        return "Recharge has done successfully and your operation ID is "+transactionsTable.size()+" and you pay "+money+" for Cancer Hospital donation service";
    }
}
