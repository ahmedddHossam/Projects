...
public class VodafoneMobileService extends Providers
{
    ...
    public String recharge(RechargeItem rechargeItem)
    {
        ...
        transactionsTable.add(new Transaction(rechargeItem.getEmail(),transactionsTable.size()+1,rechargeItem.getAmount(),rechargeItem.getNumber(),"Vodafone Mobile Service"));
        return "Recharge has done successfully and your operation ID is "+transactionsTable.size()+" and you pay "+money+" only for Vodafone Mobile service";
    }
