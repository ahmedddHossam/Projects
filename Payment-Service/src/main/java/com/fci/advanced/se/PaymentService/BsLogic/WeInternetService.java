...
@Service
public class WeInternetService extends Providers
{
    ...
    public String recharge(RechargeItem rechargeItem)
    {
        ...
        transactionsTable.add(new Transaction(rechargeItem.getEmail(),transactionsTable.size()+1,rechargeItem.getAmount(),rechargeItem.getNumber(),"We Internet Service"));
        return "Recharge has done successfully and your operation ID is "+transactionsTable.size()+" you pay "+money+" only for We Internet service";
    }
